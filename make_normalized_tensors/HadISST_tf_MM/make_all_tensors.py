...
from normalize.SPI_monthly.HadISST_tf_MM.makeDataset import getDataset
from normalize.SPI_monthly.HadISST_tf_MM.normalize import match_normal, load_fitted


sDir = os.path.dirname(os.path.realpath(__file__))

# Get the date range from the input zarr array
fn = "%s/raw_datasets/HadISST/temperature_zarr" % (os.getenv("PDIR"),)
