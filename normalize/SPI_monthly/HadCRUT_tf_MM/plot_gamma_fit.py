...
shape = iris.load_cube(
    "%s/MLP/normalisation/SPI_monthly/HadCRUT_tf_MM/shape_m%02d.nc"
    % (os.getenv("SCRATCH"), args.month),
)
location = iris.load_cube(
    "%s/MLP/normalisation/SPI_monthly/HadCRUT_tf_MM/location_m%02d.nc"
    % (os.getenv("SCRATCH"), args.month),
)
scale = iris.load_cube(
    "%s/MLP/normalisation/SPI_monthly/HadCRUT_tf_MM/scale_m%02d.nc"
    % (os.getenv("SCRATCH"), args.month),
)
