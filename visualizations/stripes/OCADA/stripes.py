...
# OCADA stripes - normalized values.
...
# Colourmap
cmap = {
    "ta": cmocean.cm.balance,
    "slp": cmocean.cm.balance,
    "precipi": cmocean.cm.tarn,
}.get(args.variable)
if cmap is None:
...
fig.savefig("%s/%s_%s_%s.webp" % (sDir, args.variable, args.reduce, args.convolve))
