Visualizations - CRU stripes
============================

.. figure:: ../../visualizations/stripes/CRU/Precip_sample_none.png
   :width: 95%
   :align: center
   :figwidth: 95%

   Normalized :doc:`precipitation stripes <precipitation_stripes>` from CRU.
...
Script (`make_all.sh`) to regenerate all the CRU stripes plots.

.. literalinclude:: ../../visualizations/stripes/CRU/make_all.sh
    :language: bash
...
.. literalinclude:: ../../visualizations/stripes/CRU/stripes.py
    :language: python
...
.. literalinclude:: ../../visualizations/stripes/CRU/makeDataset.py
    :language: python
