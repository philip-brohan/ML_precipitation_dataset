Visualizations - HadCRUT v5 stripes
===================================

.. figure:: ../../visualizations/stripes/HadCRUT/T_sample_none.png
   :width: 95%
   :align: center
   :figwidth: 95%

   Normalized :doc:`precipitation stripes <precipitation_stripes>` from HadCRUT.
...
Script (`make_all.sh`) to regenerate all the HadCRUT stripes plots.

.. literalinclude:: ../../visualizations/stripes/HadCRUT/make_all.sh
    :language: bash
...
.. literalinclude:: ../../visualizations/stripes/HadCRUT/stripes.py
    :language: python
...
.. literalinclude:: ../../visualizations/stripes/HadCRUT/makeDataset.py
    :language: python
