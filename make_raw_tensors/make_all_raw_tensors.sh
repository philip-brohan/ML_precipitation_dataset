...
(cd GC5-Central && ./make_all_tensors.py --run=dl339 --variable=uwnd)
(cd GC5-Central && ./make_all_tensors.py --run=dl340 --variable=uwnd)
(cd GC5-Central && ./make_all_tensors.py --run=dl341 --variable=uwnd)
(cd GC5-Central && ./make_all_tensors.py --run=dl339 --variable=vwnd)
(cd GC5-Central && ./make_all_tensors.py --run=dl340 --variable=vwnd)
(cd GC5-Central && ./make_all_tensors.py --run=dl341 --variable=vwnd)
(cd GC5-Central && ./make_all_tensors.py --run=dl339 --variable=rh)
(cd GC5-Central && ./make_all_tensors.py --run=dl340 --variable=rh)
(cd GC5-Central && ./make_all_tensors.py --run=dl341 --variable=rh)
