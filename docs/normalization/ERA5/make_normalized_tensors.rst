...
.. literalinclude:: ../../../make_normalized_tensors/ERA5_tf_MM/make_all_tensors.py

Calls another script to make a single tensor:

.. literalinclude:: ../../../make_normalized_tensors/ERA5_tf_MM/make_training_tensor.py

Library functions to do the normalization:

.. literalinclude:: ../../../normalize/SPI_monthly/ERA5_tf_MM/normalize.py

Library functions to convert between `tf.tensor`` and `iris.cube.cube`:

.. literalinclude:: ../../../make_normalized_tensors/ERA5_tf_MM/tensor_utils.py
