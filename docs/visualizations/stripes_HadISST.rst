Visualizations - HadISST v1 stripes
===================================

.. figure:: ../../visualizations/stripes/HadISST/v1_sample_none.png
   :width: 95%
   :align: center
   :figwidth: 95%

   Normalized :doc:`precipitation stripes <precipitation_stripes>` from HadISST.
...
Script (`make_all.sh`) to regenerate all the HadISST stripes plots.

.. literalinclude:: ../../visualizations/stripes/HadISST/make_all.sh
    :language: bash
...
.. literalinclude:: ../../visualizations/stripes/HadISST/stripes.py
    :language: python
...
.. literalinclude:: ../../visualizations/stripes/HadISST/makeDataset.py
    :language: python
