...
Difficulties with observed precipitation
----------------------------------------
...
.. figure:: ../visualizations/multi-field/raw_precip/raw_precip.png
   ...
   Precipitation distribution for March 1983 from 5 datasets
...
.. figure:: ../visualizations/raw_time_series/precipitation/precipitation_039.png
   ...
   Global mean monthly mean precipitation time-series from five datasets (with 39-month smoothing)
.. toctree::
   :titlesonly:
   :maxdepth: 1

   Monthly datasets of historical precipitation <get_data>
...
.. toctree::
   ...
   A flexible Machine Learning model for data transformations <ML_generic>
