...
parser.add_argument("--day", help="Day to plot", type=int, required=False, default=3)
parser.add_argument("--hour", help="Hour to plot", type=int, required=False, default=3)
parser.add_argument(
    "--variable",
