...
# Get monthly Copernicus satellite microwave precip for several years, and store on PDIR.
...
for year in range(args.startyear, args.endyear + 1):
    opfile = (
        "%s/Copernicus/satellite_microwave/monthly/precipitation/%04d/COBRA_%04d-01_1DM_v1.0.nc"
        % (
            os.getenv("PDIR"),
            year,
            year,
